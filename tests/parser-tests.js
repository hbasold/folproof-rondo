...
exports["Mixing implication and bi-implication is right-associative."] = function(test) {
...
exports["Forall in parentheses binds stronger than implication."] = function(test) {
	  var src = "(A x. x) -> y";
	  var result = parser.parse(src);
	  result = result[0][1];
	  test.equal(result[0], '->');
